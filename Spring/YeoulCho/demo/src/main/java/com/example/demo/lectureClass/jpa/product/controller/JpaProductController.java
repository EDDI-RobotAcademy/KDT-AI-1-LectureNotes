...
public class JpaProductController {
    ...
    @GetMapping("/list")
    public List<reactProduct> productList() {
        log.info("productList()");

        List<reactProduct> returnedProductList = productService.list();
    ...
    public reactProduct registerProduct (@RequestBody RequestProductForm requestProductForm) {
    ...
    public reactProduct readProduct (@PathVariable("productId") Long productId) {
    ...
    public reactProduct modifyProduct (@PathVariable("productId") Long productId,
