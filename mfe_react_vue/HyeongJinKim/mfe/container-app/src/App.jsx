...
import VuetifyTailwindBoardAppRouterComponent from "./router/vuetifyTailwindBoard/VuetifyTailwindBoardAppRouterComponent.jsx";
...
const App = () => {
  ...
  return (
    <div>
      <VuetifyTailwindBoardAppRouterComponent
