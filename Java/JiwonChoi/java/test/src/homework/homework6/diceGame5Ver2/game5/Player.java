...
//import static homework.homework6.diceGame5Ver2.game5.test.playerList;
...
//    public static ArrayList<Player> playerList = new ArrayList<>(); //모든 플레이어의 모음

    public Player(String playerName) {  //플레이어 이름으로 플레이어 생성
        Player.playerName = playerName;
    }

    public static void playerAdd(String playerName, ArrayList<Player> playerList) { //플레이어 이름입력하면
