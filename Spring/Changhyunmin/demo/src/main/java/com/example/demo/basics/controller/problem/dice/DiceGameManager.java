...
import com.example.demo.lectureClass.basics.controller.problem.player.Player;
...
public class DiceGameManager {
    ...
    public void applyCondition (){
        ...
        for (int i= 0; i < playerList.size(); i++){
            ...
            final int currentPlayerDiceSim = currentPlayer.getDiceSum();
            ...
            switch (conditionDiceNumber) {
                case STEAL:
                    ...
                    currentPlayer.setDiceSum(currentPlayerDiceSim + STEAL_SCORE);
                    targetPlayer.setDiceSum(currentPlayerDiceSim - STEAL_SCORE);
                    break;

                case BUFF:
                    currentPlayer.setDiceSum(currentPlayerDiceSim + BUFF_SCORE);
                    break;
    ...
    private int findTargetPlayerIdx(int currentPlayerIdx) {
