<template>
    <div>
        ...
        <p class="align-center">가운데 정렬: 으아아아 아아아아아아아아아아 아아아아 누누누다어 라ㅓ아러디라ㅓㅣㄴㅇㄹ ㅇ니ㅏ러ㅣㄴ아러ㅣㄴ 아 ㅓ리러ㅣ나  어리아ㅓ링 나ㅓㄹ대ㅑ허 차 ㅜ피타ㅟㄴ아 ㅓ리나ㅓ댜러ㅐㅑ더ㅐ ㅑㅓㅐㅑㅓㅇㄹㄴㄷㄹㅇㄹㄴ ㅇㄹㄹㄷㄹ ㄴㄷㄹ ㅣㄷ러ㅣ 널ㄷ  ㄹㄷㄴㅀㄹ</p>
        <p class="align-justify">양쪽 정렬: 으아아아 아아아아아아아아아아 아아아아 누누누다어 라ㅓ아러디라ㅓㅣㄴㅇㄹ ㅇ니ㅏ러ㅣㄴ아러ㅣㄴ 아 ㅓ리러ㅣ나  어리아ㅓ링 나ㅓㄹ대ㅑ허 차 ㅜ피타ㅟㄴ아 ㅓ리나ㅓ댜러ㅐㅑ더ㅐ ㅑㅓㅐㅑㅓㅇㄹㄴㄷㄹㅇㄹㄴ ㅇㄹㄹㄷㄹ ㄴㄷㄹ ㅣㄷ러ㅣ 널ㄷ  ㄹㄷㄴㅀㄹ</p>
        <div class="box1"></div>
        <div class="box2"></div>
...
<style scoped>
    ...
    @import url('https://fonts.googleapis.com/css2?family=Noto+Sans+KR:wght@900&family=Roboto:ital,wght@1,100&display=swap');
    p.ns-font {
