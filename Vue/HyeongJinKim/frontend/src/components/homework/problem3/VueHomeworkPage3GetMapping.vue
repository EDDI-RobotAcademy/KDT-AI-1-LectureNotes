...
export default {
  ...
  methods: {
    buyApple() {
      axios
        .get("http://localhost:7777/vue-test/buy-apple", {
          params: { appleCountData: this.appleCount },
        })
        .then((res) => {
    ...
    buyWatermelon() {
      axios
        .get("http://localhost:7777/vue-test/buy-watermelon", {
          params: { watermelonCountData: this.watermelonCount },
        })
        .then((res) => {
