...
/*
   ...
   |      isTurnOn     |
   ---------------------
   |     Led 생성자     | <<<- new를 하면 이와 같은 형태가 만들어 지는 것입니다.
   |     getTurnOn     |
   |     setTurnOn     |
   ---------------------
 */
class Led{
    ...
    // 3. 실제클래스가 new를 통해 객체화 될 때 구동시키고 싶은 작업을
    //    중괄호 내부에 배치합니다.
    ...
    // 이런 관점으로 접근하면 setter를 완벽하게 제어 할 수 있습니다.
    ...
    //             [    ] -> 20     (입력 타입 void)
    //   참/거짓 -> [    ]           (입력 타입 boolean)
    // Setter는 class 내에서 다루는 정보를 직접 설정하는 목적으로 사용합니다.
