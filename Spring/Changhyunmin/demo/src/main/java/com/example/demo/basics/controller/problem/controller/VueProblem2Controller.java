...
import com.example.demo.lectureClass.basics.controller.problem.dice.DiceGameManager;
import com.example.demo.lectureClass.basics.controller.problem.form.MultiPlayerWinnerResponseForm;
import com.example.demo.lectureClass.basics.controller.problem.form.WinnerResponseForm;
...
public class VueProblem2Controller {
    ...
    public WinnerResponseForm doFirstDiceGame (){
        ...
        WinnerResponseForm responseForm = new
                WinnerResponseForm(tmpSum,diceGameManager.checkWinIfSumEven(tmpSum));
    ...
    public MultiPlayerWinnerResponseForm doSecondGame(){
        ...
        MultiPlayerWinnerResponseForm multiPlayerWinnerResponseForm = new MultiPlayerWinnerResponseForm(diceGameManager.checkWinner()
