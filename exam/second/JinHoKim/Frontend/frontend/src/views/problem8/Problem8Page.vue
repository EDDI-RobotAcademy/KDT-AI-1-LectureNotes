...
export default {
  data() {
    return {
      carouselModel: false,
      bannerPictures: [
        { img: require("@/assets/downloadImg/cloud.jpg") },
        { img: require("@/assets/downloadImg/mapleStory.jpg") },
        { img: require("@/assets/downloadImg/dongkee.jpg") },
        { img: require("@/assets/downloadImg/bout.jpg") },
      ],
      cycle: true,
      interval: 2000,
      height: 200,
