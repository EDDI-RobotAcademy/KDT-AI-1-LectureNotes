...
public class LambdaTest {
    ...
    DDD(Domain Driven Develpoment)
    DDD를 잘 하려면 전제조건이 TDD가 깔려야 합니다
    ...
    무엇이든 처음 접근하는 것은 매우 업렵습니다.
    라지만 개발자는 처음 접근하는 것에 도전 ? 하며 깨부수는 직업입니다
    (물론 개발자도 레벨이 다양하기 때문에 요쪽은 소위 천상계라고 부릅니다)
    그리고 이 천상계로 가기 위해 반드시 필요한 작업들이 TDD, DDD 입니다

    실제로 Java 코들르 작성할 때도 문제 전체를 한 번에 만들지 않고
    여기서 문제 자체가 요구하는 사항들을 정리하였습니다.
    - 여기서 또 팁 이라면 요구 사항을 정리할 때 완벽할 필요가 없습니다.

    오히려 위의 요구 사항을 완벽하게 만드려다가 아무것도 못하고 나락으로 향하게 됩니다
    이것의 대표적인 특징 중 하나가 회의만 오질나게 하는 회사나 그룹 입니다.
