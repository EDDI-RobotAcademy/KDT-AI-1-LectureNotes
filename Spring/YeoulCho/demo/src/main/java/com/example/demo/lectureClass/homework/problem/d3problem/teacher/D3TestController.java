package com.example.demo.lectureClass.homework.problem.d3problem.teacher;

import com.example.demo.lectureClass.homework.problem.d3problem.teacher.form.HealthDataResponse;
...
public class D3TestController {
    ...
    private void allocHealthData(){
        ...
        for(int i=0; i<ONE_WEEK;i++){
            healthDataList.add(new HealthDataResponse(
