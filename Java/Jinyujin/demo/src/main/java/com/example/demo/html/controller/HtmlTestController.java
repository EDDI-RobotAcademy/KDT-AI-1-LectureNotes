...
// RestController가 붙어 있으면 데이터를 JSON 이라는 형태로 내보내게 됩니다.
...
// 아래와 같은 메시지가 나옵니다.
// 2023-04-10T11:40:00.707+09:00  INFO 9132 ---
...
public class HtmlTestController {
    ...
    // 브라우저 주소창에 주소를 입력하면 얘가 반응한다는 소리
    // 아래 코드들이 동작하여 브라우저에 뜨는 것
