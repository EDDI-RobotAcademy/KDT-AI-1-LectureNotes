...
// application.properties 파일 뒤를 yaml 로 변경해줬음
    ...
    /*
     실제 @RequestMapping("/vue-test")와 @PestMapping("/receive-test")로 URL 경로가 만들어짐
     아래쪽에 있는 @RequestBody 를 살펴봐야 합니다.
     객체화된 정보 집합을 받을 때 아래와 같이 @RequestBody 를 사용합니다.
     또한 주의할 부분이 있는데 VueRequestTestDataForm 은 vue 가 전송한 양식을 동일하게 유지하고 있어야 합니다.
    ...
    // vue쪽에도 /get-random-dice 를 설정해주어야 정보가 넘어옴
