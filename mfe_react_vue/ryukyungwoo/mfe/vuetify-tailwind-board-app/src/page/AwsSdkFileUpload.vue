<template>
    <v-container>
        ...
        <div v-for="(file, index) in awsFileList" :key="file.Key">
            #{{ index + 1 }} {{ file.Key }}
            <img :src='`https://vue-s3-test-4879.s3.ap-northeast-2.amazonaws.com/${file.Key}`'/>
...
export default {
    ...
    data () {
        return {
            file: null,
            awsBucketName: 'vue-s3-test-4879',
            awsBucketRegion: 'ap-northeast-2',
            awsIdentityPoolId: 'ap-northeast-2:21d9ff3e-bc78-4437-bbcc-5d22cf47d441',
            s3: null,
            awsFileList: [],
