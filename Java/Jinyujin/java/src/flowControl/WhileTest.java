...
public class WhileTest {
    public static void main(String[] args) {
        int idx = 0; // idx: 색인. 1page 이런 것
        final char ch = 'A'; // 캐릭터형으로 문자 A를 넣어둔 것.
                             // idx값은 변하지만 char값은 변하지 않기에 final 부여해도 됨 (대입하는게 없으니까)
        ...
        while (idx < 10) {
            ...
            // 이와 같은 이유로 실질적으로 숫자값들과 덧셈, 뺄셈 등의 연산을 수행할 수 있습니다.
            // 위 규칙에 따르면 'B'는 66이라는 것도 알 수 있습니다. -> ch + idx. 이거 때문에 쭉쭉 올라감
            idx++;
        }
    }
}
