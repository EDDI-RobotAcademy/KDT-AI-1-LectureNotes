<template>
    ...
    <div>
        ...
        <ul style="text-align: left;">
            ...
            <li>Hexagonal Aechitecture
                <ol>
                    <li>Hexagonal Aechitecture</li>
        ...
        tn은 table-head로 제목이나 메인 정보 같은 것을 배치하는편
        -->
        <table>
            <tr>
        ...
        <!-- 
            ...
            input type에는 textm numberm, submit 등등이 올 수 있습니다.
                ...
                <ul>
                    <li>
                        ...
                        <select size="5" id="subject" multiple>
                            ...
                            <option value="r2abc">R2DBC Reactive DB Sistem</option>
