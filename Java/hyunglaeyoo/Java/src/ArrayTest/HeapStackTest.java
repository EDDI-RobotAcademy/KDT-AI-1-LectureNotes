...
public class HeapStackTest {
    public static void main(String[] args) {
        ...
        for (int i = StART; i < ALLOC_ARRAY_NUMBER; i++) {
            ...
            // %s의 경우(Staring)인데 필요 없죠 java는 + 가 되니까요
            // %f의 경우엔 (floot, double)등을 처리합니다

            // printf("numberArray[%d] = %d\n", numberArray[i])
            // 위 케이스에서 첫 번째 %d와 두 번째 %d가 보입니다.
            // 첫 번째는 ', i' 가 대응해서 i 값이 %d를 대처하게 됩니다.
        ...
        // 객체를 내부의 값을 상수화 하느냐의 관점으로 봐야합니다
        // 현재 관점은 객체를 상수화하였기 때문에 다른 객체 태입이 막히는 모습입니다
