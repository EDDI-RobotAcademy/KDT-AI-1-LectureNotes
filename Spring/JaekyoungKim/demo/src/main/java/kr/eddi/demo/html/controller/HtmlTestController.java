...
//아래와 같은 메시지가 나옵니다.
//2023-04-10T11:39:53.157+09:00  INFO 20516 ---
// [nio-8080-exec-5] k.e.d.h.controller.HtmlTestController    : 잘 나옴?
// 나중에 프로젝트 할 때도 어디에서 문제 터졌는지 추적하기 위해 반드시 필요합니다.
// 지금 작업이 어디까지 진행되었는지 파악을 할 수 있기 때문에 중요합니다.

// RequestMapping은 URL Domain을 분리하기 위한 목적으로 사용합니다.
...
public class HtmlTestController {
    // HTTP 통신 방식에 GET, POST, PUT, DELETE 가 존재 합니다.
    ...
    public String printTime (Locale locale, Model model) {
        ...
        String formattedDate = dateFormat.format(date);// 날짜 형식 생석
