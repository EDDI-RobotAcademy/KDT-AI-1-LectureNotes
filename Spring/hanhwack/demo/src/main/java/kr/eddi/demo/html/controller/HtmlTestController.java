...
// 아래와 같은 메시지가 나옵니다
// 2023-04-10T11:40:45.424+09:00  INFO 11716 ---
// [nio-8080-exec-1] k.e.demo.controller.HtmlTestController   : Is it Ok ?
// 나중에 프로젝트 할 때도 어디에서 문제 터졌는지 추적하기 위해 반드시 필요합니다
// 지금 작업이 어디까지 진행되었는지 파악을 잘 할 수가 있기 때문에 중요합니다
...
// 앞에 RequestMapping("/product")같은것을 설정해서
...
public class HtmlTestController {
    ...
    // HTTP 통신 반식에 GET, POST, PUT, DELETE가 존재합니다
    // 보편적으로 웹 브라우저 주소창에 입력하는 모든 정보는 GET으로 처리합니다.
