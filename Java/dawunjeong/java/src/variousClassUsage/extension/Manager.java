...
public class Manager {
    ...
    // 예로 0, 1, 2, 3, 4, 5, 6, 6, 6, 9, 10인 형태로 배열이 있습니다.
    ...
    // 랜덤한 이메일을 만들어줘야함
    // 앞에 글자 4 ~ 8개 정도 랜덤으로 뽑자!
    // 뒤에는 @test.com을 붙이도록 한다.
    // 그리고 만드는 회원의 개수도 랜덤하게 만들자!
    // 5명 정도 만든다고 가정!
