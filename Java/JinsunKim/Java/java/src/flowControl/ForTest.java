...
//        }
        ...
        for (int idx = START; idx <= END; idx++) {
            sum += idx;
            // sum은 sum + idx라는데 왜 값이 누산(덧붙여 합산)이 되는거야 ?
            // '=' 연산자는 '~과 같다가 아닙니다'
            // 오른쪽에 있는 정보를 왼쪽에 대입합니다. 라는 뜻이다.
            // '=' 연산자는 대입연산자
...
//        }
        ...
        for (int i = START; i <= END; i++) {
            ...
            if (i % 2 ==0) {continue;}
            // continue는 skip과 동일합니다.
            // continue 에서 걸리면 아래로 내려가서 출력하지 않고 다시 위로 올라가서 증감한다.
