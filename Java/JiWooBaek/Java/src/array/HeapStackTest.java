...
public class HeapStackTest {
    public static void main(String[] args) {
        ...
        for(int num: numberArray) {
                System.out.print("numberArray elen:" + num);
        }
    }
}
