package com.example.demo.lembdaTest;
...
public class LambdaTest {
    ...
    왜에 대한 생각하기 이전에 TDD는 Test를  먼저 작성하고
    이 'Test에 대하는 코드를 만들어보자!' 가 핵심이라 보면 됩니다.
    ...
    (문론 개발자도 레벨이 다양하기 때문에 요쪽은 소위 천상계라고 부릅니다.)
    그리고 이 천상계로 가기 위해 반드시 필요한 작업들이 TDD와 DDD 입니다.
    ...
    이것은 대표적인 특징 중 하나가 회의만 오지게 하는 회사들입니다.
    회의 백날 해봐야 결론이 안나오고 여기에 쓸모없이 소요해야 하는 시간과 비용이 큽니다.
