...
public class SwitchTest {
    public static void main(String[] args) {
        /*
          Scanner 는 키보드 입력 처리를 위해 사용하는 객체입니다.
          여러분이 실제 서비스를 개발하면서 아래 코드를 사용할 일은 없지만 현재 콘솔 상황에서 사용자 입력을 받기 위해
          아래 코드가 사용된다 보면 되겠습니다.
          System.in 이란 입력 시스템을 의미하므로 입력 장치에 해당하는 키보드를 의마한다 봐도 무방하겠습니다.
        ...
        */
        ...
        while (isLoop) {
            ...
            //      case 1: 은 '입력된 숫자가 1이면' 이라는 뜻 입니다.
            // 3. 중괄호 내부에는 case 조건들을 적고 각 조건에 대응하는 코드를 작성하면 됩니다.
