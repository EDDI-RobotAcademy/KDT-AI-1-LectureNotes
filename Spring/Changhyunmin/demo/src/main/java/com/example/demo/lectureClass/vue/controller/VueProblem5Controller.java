...
import com.example.demo.lectureClass.form.GameAccountForm;
import com.example.demo.lectureClass.form.LoginResponseForm;
import com.example.demo.lectureClass.form.RequestAccountIdForm;
...
public class VueProblem5Controller {
    ...
    @PostMapping("/login")
    public LoginResponseForm gameAccountLogin
            (@RequestBody GameAccountForm gameAccountForm){
