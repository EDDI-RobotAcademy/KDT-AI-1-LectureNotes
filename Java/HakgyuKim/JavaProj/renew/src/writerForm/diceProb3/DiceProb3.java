...
public class DiceProb3 {
    public static void main(String[] args) {
        // 조건: 항상 먼저해야하는 작업은 이런식으로 문제의 조건들을 분리하는 것입니다.
        ...
        // 문제의 조건들을 다 분리 했던 ㅣ위의 케이스들은 너무 세부사항입니다.
        // 조건은 정말 저 조건들을 실제 구현해야하는 상황이 되었을 때 처리합시다.
        ...
        // [1] 초기에 세팅할까? <- 생성자인 1번에 필요한 것들을 배치
        // [2] 그냥 여기에 다 때려박을까? <- 2번 흐름에서 필요한 정보를 배치

        // 둘 중 무엇을 선택하던 플레이어를 만들게 됩니다.
        // 어쩌다 보면 주사위도 만들 수 있습니다.

        // * 주사위를 굴립니다.

        // 2번에서 중요한 역할인 주사위 굴리기가 끝났으니까
        ...
        // 오 좋은데? 근데 뭔가 이상한데?
        // 조건을 다시 보니까 특수 기능이 동작하지 않는 것을 확인합니다.
