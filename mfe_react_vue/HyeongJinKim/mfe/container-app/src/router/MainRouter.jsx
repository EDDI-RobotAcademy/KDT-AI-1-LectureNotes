...
const MainRouter = () => {
  ...
  useEffect(() => {
    ...
    observer.observe(vuetifyNavigationRef.current, {
      attributes: true,
      childList: true,
      subtree: true,
    });
    ...
    <div>
      ...
      <Suspense fallback={<div>로딩중...</div>}>
        <BrowserRouter>
          ...
          <Routes>
            <Route exact path="/vue-module-app" element={<VueModuleAppListRouter />} />
            <Route
              exact
              path="/vue-module-app/board-register-page"
              element={<VueModuleAppRegisterRouter />}
            />
            <Route
              exact
              path="/vue-module-app/board-read-page/:boardId"
              element={<VueModuleAppReadRouter />}
            />
            <Route
              exact
              path="/vue-module-app/board-modify-page/:boardId"
              element={<VueModuleAppModifyRouter />}
            />
          </Routes>
          <Routes>
            <Route
              ...
              element={<VuetifyTypeScriptBoardAppRegisterRouter />}
            />
            <Route
              exact
              path="/vuetify-typescript-board-app/read/:boardId"
              element={<VuetifyTypeScriptBoardAppReadRouter />}
            />
            <Route
              exact
              path="/vuetify-typescript-board-app/modify/:boardId"
              element={<VuetifyTypeScriptBoardAppModifyRouter />}
            />
          </Routes>
        </BrowserRouter>
      </Suspense>
