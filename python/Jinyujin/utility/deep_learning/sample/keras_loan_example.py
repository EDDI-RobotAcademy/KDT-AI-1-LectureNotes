...
for i in range(num_samples):
    ...
    # ex) 1번 케이스 - 미상환금액: 2억, 미상환건수: 5, 연체율: 30%
    #     2번 케이스 - 미상환금액: 10억, 미상환건수: 10, 연체율: 30%
    #     3번 케이스 - 미상환금액: 3000만원, 미상환건수: 1, 연체율: 10%
...
# 총 16개의 label이 만들어질 것이라고 함

# model = Sequential()
# model.add(Dense(32, activation='relu', input_shape=(3, )))
# model.add(Dense(64, activation='relu'))
# # 맨 앞에는 그냥 내키는 2의 n승 숫자를 넣음
