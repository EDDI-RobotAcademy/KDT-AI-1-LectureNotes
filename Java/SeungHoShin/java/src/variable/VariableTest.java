...
public class VariableTest {
    public static void main(String[] args) {
     ...
     //     long: 비슷함
     //     float: 소주점
     //     double: 저금 더 정밀한 소주점(실제 작업하면서 double 사용할 일은 거의 드음)
     ...
     int applecount =3;
        ...
        // 1. 아래 있는 [비교 대상] 을 보면 3.3 를 직접 기입하고 있으므로
        ...
        int income =1000000;
        System.out.println("프리랜서 세전 수입:" + income +" , 세후:" +income * (FULL_PERCENT- TAX)/FULL_PERCENT);
        /* [비교 대상]
         System.out.println("프리랜서 세전 수입:" + income =" , 세후:" +income * (FULL_PERCENT- 3.3f)/FULL_PERCENT);
         */
        ...
        // 만들전 중 코드에 계속, 1과2 가 날아오니까
        // 신입은 그냥 들오는 숫자를 3으로 대입하고 문제를 해결했습니다.
        // 이 상황에센 예금을 했더니 조회가 되고
        // 출금을 했더니 조회가 되고
