<template lang="">
    ...
    <div>
        ...
        <h6>원래는 코드 형태 출력이 아닌 실제 코드가 동작해야 한다.</h6>
        <h4>chatgpt 같은 것을 만든다면 필요할지도 모르겠네요.</h4>
        <!--
            강제 스타일 먹이기는 아래와 같이 style="css속성"
            여기서 css 속성은 text-aling으로
            글자를 정렬할 때 사용하며 디폴트로 center 정렬이였으나
            아래 fuction saveLocal .... 에 대해서는 left 정렬을 적용하는 작업이다.
        -->
        ...
        <!--
            ...
            tr은 table-row에 해당하며 td는 table-data로 cell 혹은 cloumn이라 봐도 무방
        ...
        <table style="width:600px">
            ...
            <caption>
                ...
                <p>Pursue agile process based development</p>
            </caption>
            <tr>
                <th>Name</th>
                <td>이름</td>
        ...
        <!--
            image를 추가하고 싶을 때는 아래와 같이 이미지가 위치하는 경로를 지정해주면 된다.
            부가적으로 download를 확보 했는지 아니면
            실질적으로 서비스 차원에서 사용자가 등록한 이미지인지 같은 것을 디렉토리 이름으로 구별하면 좋다.
        -->
        <h2>Image</h2>
        <img src="@/assets/downloadImg/mario_run.png">
        <!-- figure로 image를 감싸고 figcaption을 달면 image에 대한 설명을 붙일 수 있다. -->
        <figure>
            <img src="@/assets/downloadImg/mario_run.png">
        ...
        <!--
            ...
            method에 post를 지정할 수 있고 default 값은 get 입니다.
            input type에는 text, number, submit 등등이 올 수 있습니다.
            text는 말 그대로 문자열, number는 숫자, submit은 등록 개념이라 보면 된다.
            속성 값 value를 통해 표기되는 형태를 지정할 수 있다.
            추후 이 부분의 submit을 prevent 하여 vue가 axios 하도록 구성하게 된다.
        -->
        <form action="/">
        ...
        <!--
            다중 선택(checkbox)
            input type으로 checkbox를 사용하여 value 값에 선택한 값을 볼 수 있다.
            javascript에서 어떤 값을 선택 했는지 처리할 수 있고
            이를 토대로 vue쪽에 axios 하는 데이터를 처리할 수 있다.
        -->
        <h3>다중 선택</h3>
        ...
        <!--
            단일 선택(radio)
            input type으로 radio 사용하여 value 값에 선택한 값을 볼 수 있다.
        ...
        <form action="/" style="text-align: left">
            <li>
                <lable><input type="radio" name="subject" Value="rust">Rust</lable>
            </li>
            <li>
                <lable><input type="radio" name="subject" Value="typescript">Typescript</lable>
            </li>
            <li>
                <lable><input type="radio" name="subject" Value="kotlin">Kotlin</lable>
            </li>
        </form>
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <!-- 
                                ...
                                최소값, 최대값, 초기값, step 성정은 위의 number와 완벽하게 동일함
                            -->
            ...
            <fieldset>
                ...
                <ul>
                    <li>
                        ...
                        <!-- 
                            select의 경우엔 드롭 다운 형태의 목록을 만들 수 있다.
                            multiple을 선택하여 여러 옵션들을 복수 선택 할 수 있다.
                            size는 눈에 보이는 리스트의 개수이다.
                        -->
                        <select size="5" id="subject" multiple>
                            <!-- option에는 실제 배치하고 싶은 옵션 리스트를 작성한다. -->
