...
public class VariableTest {
    public static void main(String[] args) {
        ...
        // 상수로 고정시킬수 있다는 것의 이점이란 무엇인가 ? ( 왜 변수가 아니고 상수를 쓰면 좋을까 )
        ...
        //    한번 변경하면 모든 작업이 일괄처리 되므로 편합니다. (유지보수의 편리성)
        ...
        // 이 상황에서 예금을 했더니 "조회"가 되고
        // 출금을 했더니 "조회"가 되고
        // 조회를 했더니 "조회"가 되는 끔찍한 상황이 연출됩니다.
        // 이것을 "원천 차단" 하는 방법으로서 final을 사용합니다.
