...
public class SwitchTest {
    ...
    public static void main(String[] args) {
        ...
        //현재 콘솔 상항에서 사용자 입력을 받기 위해 아래코드가 사용된다 보면 되겠습니다.
        ...
        while (isLoop) {
            ...
            //키보드 입력으로 int타입을 수신한다면 nextint()를 사용합니다.
            //만약 double 타입을 원한다면 nextdouble()
            //float 타입을 원한다면 nextfloat 형태로 사용하면 됩니다.
            int inputNumber = scan.nextInt();

            // switch 문을 작성하는 방법
            //1. switch 를 적고 소괄호()를 작성하고 중괄호{}를 작성합니다.
            //2.소괄호 내부에 switch case에서 사용할 조건을 적습니다.
            //      ->현재 케이스에서 intputNumber는 숫자이므로
            //      case0: 의 의미는 '입력된 숫자가 0이면'이라는 뜻을 가집니다.
            //      case1: 은 '입력된 숫자가 1이면' 이란 뜻입니다.
