...
//                현재 콘솔 상황에서 사용자 입력을 받기 위해 아래 코드가 사용된다 보면 된다.

//        사용자 입력이란 구체적으로 키보드 입력을 의미하므로
//                입력 장치에 해당하는 키보드를 의미한다 봐도 무방하다.

//                -> 결론 : 사람의 키보드 입력을 받고 싶으면 아래 코드 한 줄을 입력하세요.
        Scanner scan = new Scanner(System.in);

//        boolean : 참/거짓을 표현하는 자료형이다.
        boolean isLoop = true;
...
//            switch 문을 작성하는 방법
//            1. switch 를 적고 소괄호()를 작성하고 중괄호{}를 작성한다.
//            2. 소괄호 내부에 switch case에서 사용할 조건을 적는다.
//                -> 현재 케이스에서 inputNumber는 숫자이므로
//                case 0:의 의미는 '입력된 숫자가 0이면' 이라는 뜻을 가진다.
//                case 1 : 은 '입력된 숫자가 1이면' 이란 뜻이다.
