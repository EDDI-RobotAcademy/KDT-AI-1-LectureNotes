...
export const registerProduct = (productName, price) =>
    axios.post("http://localhost:7777/jpa-product/register", { productName, price })

export const fetchProduct = (productId) =>
    axios.get(`http://localhost:7777/jpa-product/${productId}`)

export const removeProduct = (productId) =>
    axios.delete(`http://localhost:7777/jpa-product/${productId}`)
