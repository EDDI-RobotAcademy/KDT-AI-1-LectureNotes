...
export default {
    ...
    data(){
        return {
            file: null,
            awsBucketName: process.env.VUE_APP_S3_BUCKET_NAME, //'vue-s3-test', 
            awsBucketRegion: process.env.VUE_APP_S3_REGION, //'ap-northeast-2',
            awsIdentityPoolId: process.env.VUE_APP_S3_IDENTITY_POOL_ID, //'ap-northeast-2:f258493e-a464-45be-a286-424387a66ff1',
            s3: null,
            awsFileList: [],
