...
vehicle_actions_mapping = {action: i for i, action in enumerate(actions)}
mapped_labels = [vehicle_actions_mapping[action] for action in labels]
print(mapped_labels)
...
model.fit(encoded_traffic_light, encoded_action, epochs=50, batch_size=32)
