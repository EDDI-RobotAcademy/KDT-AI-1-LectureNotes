...
async def get_device_details():
    ...
    # 그리고 이 스펙 사항과 python 코드가 구동한 결과가 일치해야 올바르게 작동합니다
...
async def create_virtual_credit():
    ...
    # np.random.normal()에 평균과 표준편차를 입력해서 해당 함수를 따르는 값들을 만들어달라 요청하는 함수입니다
    ...
    # 표준편차의 크냐 작냐에 따라 괴리의 정보를 볼 수 있을 것
...
async def make_excel():
    ...
    # 이거 통신되면 data.xlsx라는 파일이 만들어지고 info_data 값이 들어가 있음!
