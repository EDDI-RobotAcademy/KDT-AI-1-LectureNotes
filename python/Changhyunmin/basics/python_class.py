...
def class_test_function():
    ...
    p.print_info()
    # 이 문법이 별로인 이유
    # 다른곳에서 사용할려 해도 값이 변해서 제활용이 안되기때문
    p.name = "이거 된다"
    p.print_info()
    #사용하지 마세요
    Person.title = "이것도 된다"
    ...
    #OpOverload = 연산자를 도와준다. 코드 간결성때문에 사용을 많이 한다.
    obj1 = OpOverload(10)
    obj2 = OpOverload(33)
    print(obj1 + obj2)
    print(obj1 - obj2)
    ...
    chageable_date = date(2023,5,26)
    print(remain_date - chageable_date)