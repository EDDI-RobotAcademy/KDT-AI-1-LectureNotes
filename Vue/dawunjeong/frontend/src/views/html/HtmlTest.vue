<template lang="">
    ...
    <div>
        ...
        <!-- 
            강제 스타일 먹이기는 아래와 같이 style="css 속성"
            여기서 css 속성은 text-align으로 
            글자를 정렬할 때 사용하며 디폴트로 center 정렬이었으나
        ...
        -->
        <h2>Image</h2>
        <img src="@/assets/downloadImg/mario.png">
        ...
        <!-- 
            ...
            inpit type에는 text, number, submit 등등이 올 수 있습니다.
        ...
        <!--
            ...
            이름 토대로 vue쪽에 axios 하는 데이터를 처리할 수 있습니다.
        -->
        <h3>다중 선택</h3>
        ...
        <form action="/" style="text-align: left;">
            <li>
                <label for=""><input type="radio" name="subject" value="rust">Rust</label>
            </li>
            <li>
                <label for=""><input type="radio" name="subject" value="typescript">Typescript</label>
            </li>
            <li>
                <label for=""><input type="radio" name="subject" value="Kotlin">Kotlin</label>
            </li>
        </form>
                    ...
                    <ul>
                        <li>
                            ...
                            <!-- 
                                ...
                                화샆료 UI가 제공되는데 누를 때마다 이동하는 숫자의 크기는 step
                            -->
                        ...
                        <li>
                            ...
                            -->
                            <input type="range" id="satisfy" value="1" min="0" max="5" step="1">
                        </li>
                    </ul>
            </fieldset>
        </form>
                ...
                <ul>
                    <li>
                        ...
                        <select size="5" id="subject" multiple>
                            ...
                            <option value="mas">MSA 설계</option>
                            ...
                            <option value="mfe">Micro Frontend Service 설계</option>
                            <option value="edm">Event Driven MAS</option>
