<template lang="">
    <div>
        ...
        매개변수고 boards값이 script 흐름에따라 아래에서 온다.
...
export default {
    ...
    // 즉 html 코드에 표현될 정보가 미리 계산되어 있다고 생각하면 된다.
    ...
    computed: {
        ...
        ...mapState(boardModule, ['boards']), // 게시물 리스트를 가지고 옴
    },
    // mounted 무조건 실행
    mounted () {
        // vuex의 action 호출
