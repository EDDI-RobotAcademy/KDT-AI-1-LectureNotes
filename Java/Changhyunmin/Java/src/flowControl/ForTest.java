...
public class ForTest {
    public static void main(String[] args) {
        ...
        //  조건을 만조하는 동안 for문이 반복됩니다.
        //  -증감의 경우에도 없어도 됩니다.
        //  표현을 더 예쁘게 만들어주기 위해 증감파트가 존재한다고 봐도 무방합니다.
        //3. 중괄호 내에는 for문을 반복하며 작업할 내용을 적어줍니다.


        //중요한것은 어찌되었든 for문은
        //조건파트가 참인 동안은 언제든지 반보된다는 것입니다.
        //초기화나 증감파튼는 곁다리란 것이죠.
        ...
        //외부 0으로 초기화된 변수를 가지고 누산해야합니다.
        for (int idx = START; idx<= END; idx++) {
            //sum += idx;
            //sum은 sum+idx라는데 왜값이 누산이되는거야?
            //'=' 연산자는 '~과 같다가 아닙니다'
            //오른쪽에 있는 정보를 왼쪼에 대입합니다.
            //'='연산자는 대입 연산자
            sum = sum + idx;
...
//        }
        for(int i = START; i <= END; i++){
            //'%'연산자는 나머지 연산자 입니다.
            // (mod 2)와 동의어 이며 이건 몰라도 됩니다.

            //현재i 값은 2로 나눈 나머지가 0 이냐를 묻는 것이고
            //2로 나눈 나머지가 0이란 것은 짝수임을 의미합니다.
            //고로 이 로직은 3~10 사이의 홀수만 출력합니다.

            if(i % 2==0) {continue;} //continue는 skip과 동일합니다.
