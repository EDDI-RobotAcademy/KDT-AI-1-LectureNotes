<template lang="">
    ...
    <div>
        ...
        <p><strong>TypeSxript</strong> <b>javascript</b> Python</p>
        <!-- em과 i는 모두 이탤릭체를 표현함 -->
        ...
        <!--
            ...
            tr은 table-row에 해당하며 td는 table_data로 coll 혹은 columns이라 봐도 무방
        ...
        <!--
            ...
            이를 토대로 vue 쪽에서 axios 하는 데이터를 처리할 수 있습니다. 
        -->
        <h3>다중 선택</h3>
        ...
        <form action="/" style="text-align : left;">
            ...
            <li>
                <label><input type="radio" name="subject" value="Kotilin">Kotlin</label>
            </li>
        </form>
            ...
            <fieldset>
                ...
                <ul>
                    <li>
                        ...
                        <!--
                            select의 경우엔 드롭다운 형태의 목록을 만들 수 있습니다. 
