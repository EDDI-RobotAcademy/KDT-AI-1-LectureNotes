...
public class VariableTest {
    public static void main(String[] args) {
        ...
        // long: 더 큰 타입 정수형
        // float : 부동소수점
        // double: 더 정밀한 부동소수점 (실제 작업하면서 double type 을 사용하는 경우는 적음.)
        //2. 변수 이름을 작성한다.   (이름은 우리가 만들고 싶은대로 만들 수 있다.)
        //3. 필요하다면 초기화를 진행한다.

        // 결론적으로 변수를 만들 대 가장 주요한 것은
        ...
        // 상수로 고정 시킬 수 있다는 것의 이점이란 무엇인가?

        // 1. 아래 있는 [비교 대상을] 보면 3.3f를 직접 기입하고 있으므로
