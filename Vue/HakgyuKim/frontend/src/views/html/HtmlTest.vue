<template lang="">
    ...
    <div>
        ...
        <table style="width: 600px">
            <!-- caption을 통해서 table(표)에 제못 비스무리한 느낌을 줄 수 있음-->
            <caption>
        ...
        <!-- 
            Image를 추가하고 싶을 때는 아래와 같이 이미지가 위치하는 경로
        ...
        <!-- 
            form 태그는 말 그대로 format(약식)을 저장해서 데이터를 전송합니다
        ...
        <form action="/" style="text-align: left;">
            <li>
                <label><input type="radio" name="subject" value="subject">Rust</label>
            </li> 
            <li>
                <label><input type="radio" name="subject" value="subject">Typescript</label>
            </li>
            <li>
                <label><input type="radio" name="subject" value="subject">Kotlin</label>
            </li>
        </form>
                ...
                <ul>
                    <li>
                        ...
                        <select size="5" id="subject" multiple>
                            ...
                            <option value="hexagonal">Hexagonal 아키택처</option>
                            ...
                            <option value="jap">Reactive에서는 사용할 수 없는 JPA</option>
...
<style scoped>
    ...
    th {
        padding: 20px; /* t셀 태두리와 내용 사이의 간격(패딩) */
    }
    td {
        padding: 7px;
    }
