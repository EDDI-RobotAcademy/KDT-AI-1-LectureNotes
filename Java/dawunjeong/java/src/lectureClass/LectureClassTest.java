...
class Led {
    ...
    // 만드는 규칙이라면 아래와 같습니다.
    // 1. public을 적고 클래스 이름을 적은 이후 소괄호()를 작성 후 중괄호{}를 작성합니다.
    ...
    //    숫자 등등이라면 Long(long) 이나 Integer(Int) 입니다.
    //    무엇을 반환(리턴) 하느냐에 따라 적절한 형태를 적어주면 됩니다.

    // * 도대체 리턴된다는 것은 무엇을 의미 하는가 ?
    // 3 -> [     ] -> 9 (리턴 타입 Int)
    ...
    // 비즈니스 관점을 좀 더 명확하게 만들어준다는 이점이 잇습니다.
