...
public class VariableTest {
    public static void main(String[] args) {
        ...
        // 문자열 + 숫자의 경우엔 앞에 문자열이 나왔기 떄문에
        // 자동으로 숫자를 문자열 처리하여 화면에 출력합니다.
        System.out.println("totalCount = " + totalCount);

        // final을 사용하는 이유: 우선 상수로 고정시킬수 있다는 이점이 있음
        // 상수로 고정시킬 수 있다는 것의 이점이란 무엇인가?

        //1. 유지보수
        //  아래 있는 [ 비교 대상 ] 을 보면 3.3f를 직접 기입하고 있으므로
        //  향후 프로그램이 커지면 직접 3.3f를 작성한 부분을 모두 찾아서
        //  TAX 변경에 따라 모든 코드를 수정해야하는 불편함이 발생합니다.
        //  TAX 상수에 숫자를 기입하고 이상수를 사용한다면
