...
public class StackArrayTest {
    public static void main(String[] args) {
        ...
        // 첫번째 - 이유 -> 초기화나 조건등이 있어 향후 변경에 유리하다 생각
        // 두번째 - 이유 -> 전자는 계속 조건식을 검사해야함

        // 이런 이유때문에 사실 데이터를 요청하면
        // 뭉태기로 한번에 쏘지 않고 필요한 정보만 선별해서 쏘게 됩니다.
