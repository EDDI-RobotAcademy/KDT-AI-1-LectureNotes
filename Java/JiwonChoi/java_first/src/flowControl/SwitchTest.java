...
public class SwitchTest {
    ...
    public  static void main(String[] args) {
        ...
        // 여러분이 실체 서비스를 개발하면서 아래 코드를 사용할 일은 없지만
        // 현재 콘솔 상황에서 사용자 입력을 받기 위해 아래 코드가 사용된다 보면 되겠다.
        // 사용자 입력이란 구체적으로 키보드 입력을 의미한다.
        // System.in 이란 입력 시스템을 의미하므로
        // 입력 장치에 해당하는 키보드를 의미한다 봐도 무방하다.

        // 결론 : 사람의 키보드 입력을 받고 싶으면 아래 코드 한 줄을 입력하면 된다.
        Scanner scan = new Scanner(System.in);

        //boolean: 참/거짓을 표현하는 자료형입니다.
        boolean isLoop = true;

        //isLoop가 true인 동안 반복한다.
        while (isLoop) {
            ...
            //      case 0:의 의미는 '입력된 숫자가 0이면'이란 뜻이다.
            //      case 1: 의 의미는 '입력된 숫자가 1이면'이란 뜻이다.
            // 3.중괄호 내부에는 case 조건들을 적고, 각 조건에 대응하는 코드를 작성한다.
            switch (inputNumber) {
                case 0:
                    // 숫자 0이 들어오는 경우 isLoop를 false(거짓)으로 바꾼다.
