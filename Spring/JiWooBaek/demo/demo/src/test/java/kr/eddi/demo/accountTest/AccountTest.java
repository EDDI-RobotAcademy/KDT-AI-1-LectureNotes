...
public class AccountTest {
    ...
    void 사용자가_회원_가입한다 () {
        ...
        // 사실 이전에도 Java 수업 떄 이야기 했던 내용입니다.
        ...
        // Entity에 데이터와 이를 제어하기 위한 메서들을 전부 때려박으면
        // Entity object = new Entity();
        // object.이게뭐야(음몰라.아무거나다해());와 같은 코드가 만들어집니다.
        // 넌뭐하는 엔티티.나도몰라(object.이것도한다());
    }
