<template>
    <div>
        <!-- 
            ...
            buttom type="submit"이 동작하지 않게 만들었음
...
export default {
    ...
    methods: {
        ...
        const { 정보 } = this를 통해서 특정 정보를 객체화할 수 있습니다.
        ...
        */
        onSubmit () {
            ...
            // 실제 Spring 파트에서 *.yaml을 통해 server port 777로 지정하였습니다.
            ...
            // PostMapping, GetMapping이 주된 통신 방식이며,
            // GetMapping은 정보가 URL에 전부 노출됩니다.
            // 아이디와 패스워드는 GetMapping하면 안된다.
