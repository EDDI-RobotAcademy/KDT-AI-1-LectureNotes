...
public class AccountTest {
    ...
    void 사용자가_회원_가입한다 () {
        ...
        // 그냥 class 에 데이터 넣고 이 데이터를 제어할 수 있는 매서드를 만들라는 형식으로 설명함
        ...
        // 이와 같은 이유로 DB에 저장하는 작업은 Repository 로 분리합니다.
        ...
        // 재사용성이 올라간다.
        // Controller 에서 여러 Service 를 활용하는 경우가 발생함
        // Service 에서 여러 Repository 를 활용하는 경우가 발생하기 시작함

        // 위와 같이 분리하지 않고 모든 책에 나온대로
        // Entity 에 데이터와 이를 제어하기 위한 매서들를 전부 때려박으면
