...
export default {
    data() {
        return {
            ...
            reg_data: [
                ...
                { date: "25-Apr-23", amount: 93.23 },
                { date: "26-Apr-23", amount: 93.65 },
                { date: "27-Apr-23", amount: 93.19 },
                { date: "28-Apr-23", amount: 93.97 },
                { date: "1-May-23", amount: 100.39 },
                { date: "2-May-23", amount: 93.27 },
                { date: "3-May-23", amount: 103.65 },
    ...
    computed: {
        ...
        xScale() {
            ...
            // domain을 보면 this.data(data: [90.9, 90, 90.2, 25, 10.2, 92])가 들어가서 d,i를 나누고 있음
    ...
    mounted() {
        ...
        // 전체 화면에서 오른쪽으로 40만큼 수평이동 시켜서 왼쪽에 숫자를 출력할 구간을 확보함(버그 해결)
            .attr("transform", "translate(40," + height + ")")
            .call(d3.axisBottom(x))

        // https://observablehq.com/@d3/d3-line
        // append에 관한 것 확인할 수 있는 주소
        g.append("g")
            .call(d3.axisLeft(y))
        ...
        g.append("path")
            ...
            // g.append를 통해서 그래프가 어떤 방식으로 바뀌는지 볼 수 있음
    }
}
</script>
<style lang="">
