<template lang="">
    <v-container>
        <svg :width="width" :height="height">
            ...
            <!-- 의미 없는 원 그려봄 -->
            <circle cx=100 cy=200 r=40 stroke=#412322 fill=red></circle>
        </svg>
    </v-container>
</template>
...
export default {
    ...
    computed: {
        ...
        line () {
            ...
            console.log('path()에서 불러짐: 넌 언제 그러지니?')
            return d3.line()
                .x((d, i) => this.xScale(i))
                .y((d) => this.yScale(d))
        },
        xScale () {
            ...
            // 여기서는 실제로 가지고 있는 데이터를 표현하는 화면의 비율에 맞게 스케일 작업을 진행
    ...
    mounted () {
        ...
        g.append("g")
            ...
            // 여기서도 40만큼 수평이동 시켜서 이상하지 않게 만들어야 함
