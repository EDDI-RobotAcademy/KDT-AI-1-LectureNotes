...
min_loan_amount = 300000000  # 최소 대출 금액
max_loan_amount = 1000000000  # 최대 대출 금액
step_size = 10000000  # 단위

num_samples = 1000  # 천개의 예시를 만들거임

# 미상환 금액 (아직 갚지 않았다.)
# min_loan_amount 과 max_loan_amount 사이의 정수 값을 갖는 num_samples(천개)의 배열
...
# min_loan_amount 에서 max_loan_amount 까지 step_size 만큼 간격의 값의 배열 생성
