...
class Led {
    ...
    //    이름은 역시나 이 작업이 무성을 하는지 명시적으로 알려줄 수 있는 형태가 좋습니다.
    ...
    // 사실을 지가 지를 킬 수 없기 때문에 다른 객체의 도움을 받아야함
    ...
    // 그리고 Request 를 보고 적절한 Entity를 추출하게 되는데
