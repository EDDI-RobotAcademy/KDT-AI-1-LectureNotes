...
public class LambdaTest {
    ...
    이것이 대표적인 특징 중 하나가 희의만 오질라게 하는 회사나 그룹입니다.
    회의 백날 해봐야 결론이 안나오고 여기에 쓸무없이 소요해야 하는 시간과 비용이 매우 큽니다.
    실제로 이렇게 희의만 수 개월에서 수 년을 하다가 아무것도 못하고 사라지는 경우가 많습니다.
    ...
    이 이야기는 TDD와 DDD에 연계된 철학 속에 내표된 내용이고
