...
export default {
    ...
    methods: {
        /*
        위쪽의 template 파트 html은 전부v-model로 연결되어 있어서 사용자에 입력에 따라 값이 바뀝니다
        그러므로 this.를 통해 입력된 값들을 전달 할 수 있습니다.
        this가 data()에 있는name, major, age를 모두 포함하기 때문입니다.
        const {{정보}} =this를 통해 특정 정보를 객체화 할 수 있습니다.
