    ...
    public static void main(String[] args) {
        ...
        */
        ...
        for(int idx = START; idx <= END; idx++){
            sum += idx;
            // sum = sum + idx 와 같음
            // sum은 sum + idx라는데 왜 값이 누산이 되는가?
            // '=' 연산자는 '같다'라고 비교하는 것이 아닌
            // 오른쪽에 있는 정보를 왼쪽에 대입하는 연산자입니다.
...
//        }
        ...
        for(int i = START; i <= END; i++){
            ...
            // i값을 2로 나눈 나머지가 0이냐 묻는 것이고
            // 이것은 짝수냐고 묻는 것을 의미합니다.
            // 고로 이 로직은 3에서 10사이의 홀수만 출력합니다.
            if(i % 2 == 0)
                continue; // continue는 skip의 의미 (밑에 있는 줄 무시하고 다음 반복문 실행)
