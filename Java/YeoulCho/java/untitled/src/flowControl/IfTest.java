...
public class IfTest {
    public static void main(String[] args) {
        ...
        //if 문을 만드는 방법
        // 1. if 를 작성하고 소괄호()를 작성하고 중괄호{}를 작성합니다.
        // 2. 소괄호 내부에 조건식을 작성합니다.
        // 3. 중괄호 내부에는 조건이 만족된 경우 동작한 코드를 작성합니다.
        ...
        //그리고 그 다음 else if에서는 맨 처음 if가 만족하지 않고, 그다음 else if 를 만족하지 않고
        //그리고 현재의 else if 조건을 만족해야 합니다.

        // 그러므로 depth(깊이)가 깊어질수록 코드를 파악하기 위한 혼동이 가중된다는 문제가 있습니다.
        // 이와 같은 이유 때문에 코드를 작성할 때 if, else if, else if ㅗ다는
        // 그냥 if, if, if가 더 좋습니다.(우리는 서비스 개발자니까)
