...
public class WhileTest {
    public static void main(String[] args) {
        ...
        int ch= 'a';
        //  while 문 작성 방법
        //  1. 일단 while을 적고 소괄호를 작성하고 중괄호를 작성하빈다.
        //  2. 소괄호 내부에 조건식을 작성합니다.
        //  <<<--- idx< 10의 엄밀한 뜻은 아래와 같습니다.
        //  idx 변수의 값이 숫자 10보다 작은게 맞니? 라고 물어보는 것입니다.
        //  그리고 그 답으로 참(TRUE) 혹은 거짓(FALSE)가 튀어나오는 것입니다.
        //  while(true) 혹은 while(false)로 치환 되므로
        ...
        while (idx<10){
            ...
            // 이와 같은 이유로 실질적으로 숫자값들과 덧셈, 뺄쎔등의 연산을 수행할 수 있습니다.
