...
public class ForTest {
    public static void main(String[] args) {
        ...
        //for 문을 만드는 방법
        //1. for를 작성하고 소괄호()를 작성 후 중괄호{}를 작성합ㄴ다.
        //2. 소괄호 내부는 아래와 같이 구성됩니다.
        //      (초기화;조건; 증감)
        //      여기서 초기화란 for 문을 최초로 만나는 순간에만 동작하게 됩니다.
        //      그러므로 없어도 됩니다.
        ...
        // 루프를 돌면서 덧셈을 하려면 반드시 아래과 같이
        //외부에 0으로 초기화된 변수를 가지고 누산해야합니다.
        int sum = 0;
        int count = 0;
...
//        }
        for ( int i = START; i<= END; i++){
            ...
            //2로 나눈 나머지가 0이란 것은 짝수를 의미합니다.
            //고로 이로직은 3~10 사이의 홀수만 출력합니다.
