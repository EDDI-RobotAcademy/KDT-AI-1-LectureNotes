...
public class HeapArrayTest {
    public static void main(String[] args) {
        ...
        for (int i = START; i < ALLOC_ARRAY_NUMBER; i++) {
            ...
            // printf("numberArrat[%d] = %d\n", i , numberArray[i])
            // 위 케이스에서 첫 번째 %d와 두 번째 %d가 보입니다.
            // 첫 번째는 ', i'가 대응해서 i 갓이 %d를 대체하게 됩니다.
        ...
        // 못 바꾸게 하고 싶으면 final int num도 가능
        ...
        // final int[] numberArray = new int[ALLOC_ARRAY_NUMBER];로
        // ALLOC_ARRAY_NUMBER을 상수화 한 것이고
