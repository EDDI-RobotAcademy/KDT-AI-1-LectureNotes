...
class Led {
    ...
    //  만드는 규칙이라면 아래와 같습니다.
    //  1. public을 적고 클래스 이름을 적은 이후 소괄호() 작성 후 중괄호 {}를 작성합니다.
    ...
    //  매서드를 작성하는 방법
    //  1. public을 작성하고 소괄호()를 작성하고 중괄호{} 작성합니다.
    ...
    //             [     ] -> 20    (리턴 타입 int)
    //  생성자는 리턴이 없음 void랑 다름

    public Boolean getIsTurnON () {
        return isTurnON;
    }

    //  사실 지가 지를 킬 수 없기 때문에 다른 객체의 도움을 받아야 함
...
public class LectureClassTest {
    public static void main(String[] args) {
        ...
        //  즉 내가 집중하는 주제가 무엇인가 알 수 있도록 예쁘게 잘 표현해주는 것을 OOP라고 봐도 무방합니다.
