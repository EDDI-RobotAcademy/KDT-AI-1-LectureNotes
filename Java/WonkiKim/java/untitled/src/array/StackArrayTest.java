...
public class StackArrayTest {
    public static void main(String[] args) {
        ...
        // 배열을 만드는 방법 ( 일단 final은 스킵)
        // 1. 데이터 타입을 적고 대괄호를 작성한다.
        // 2. 변수 선언하듯 변수 이름을 작성합니다.
        //    당연히 이름이기 때문에 전달력 및 표현력이 중요합니다.
        // 3. 필요하다면 중괄호를 열고 초기화를 하거나
        //    또는 new 데이터 타입(1번) [] 형태로 heap메모리에 메모리 할당을 강제할 수 있습니다.
        ...
        // Loop { final int data} 형태로 있다면
        // data 변수가 루프마다 초기화 되는 것을 볼 수 있습니다.
        // 이런 지역변수 특성을 가지는녀석들은 죄다 Stack입니다.
        ...
        // 배열의 경우 아래와 같이 numberArray.length 형태로 전체길이를 파악할 수 있습니다.
        for (int i= START; i < numberArray.length; i++) {
            ...
            // 주의할 부분이라면 배열의 시작이 0 부터 라는 것에 주의를 해주세요.
            // 우리는 1 부터 100까지라고 말하지만
            // 배열은 0 부터 99까지 움직이게 됩니다.

            // final int[] numberArray = {1, 2, 3, 4, 5};
            // 위 코드는 아래와 같이 배치되어 있습니다.
