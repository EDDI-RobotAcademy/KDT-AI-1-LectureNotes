...
public class VariableTest {
    public static void main(String[] args) {
        ...
        //변수를 만드는 방법
        //1. 데이터 타입을적는다 (int, float, double, ling)
        //   int: 정수형 (숫자 - 음수, 양수)
        //   ling: 비슷함
