...
public class StackArrayTest {
    public static void main(String[] args) {
        ...
        // 배열을 만드는 방법 (일단 final은 제끼십쇼)
        // 1. 데이터 타입을 적고 대괄호[]를 적습니다.
        // 2. 변수 선언하듯 변수 이름을 작성합니다.
        //    당연히 전달력 및 표현력이 중요합니다.
        ...
        // ... if 서비스 회사에서 서비스를 만드는데 데이터가 천만 건이라 하면,
        ...
        //... 한 번에 다 때려박는 것보다 분리 시키는 것이 좋은 것
        // 이런걸 접근할 때는 돈 관점에서 보면 된다
        // 많이 땡기면 많이 줘야 하고 적게 땡기면 적게 주면 됨

        //... 출석이라는 서비스 - 실질적으로 우리가 관심있는 정보는 당일 vs 월별, 1년치
        // -> 당일. 다른 날짜는 아직 관심 없음. 근데 다른 날짜 있는 경우들은 요청해서 미리 땡겨온것 (20일 * 6개월)
        //    이런 경우는 길바닥에 돈을 뿌린 것 - 요금 폭탄 맞고 문제가 됨. 자체 서버 있는 경우 노 상관
        // AWS: 아마존 웹서비스. 서버 운영해주는 곳. 서비스 배포 버전 올리게 되면 대행업체에 돈 지불
        //      직접한다면 건물 땅 등 구해야하는 것 그래서 AWS 사용하고 돈 지불하는 것
