...
num_samples = 1000
# 미상환 금액
random_outstanding_amounts = np.random.randint(min_loan_amount, max_loan_amount +1, size=num_samples) * 10000
# 미상환 건수
...
for i in range(num_samples):
    # outstanding_amounts는 OK, 나머지는 amount를 계산할 때 적정 계수값을 곱해서 조정하도록 해야함
    # 일단 예제니까 그냥 더하도록 함
