<template>
    <div>
        ...
        <h1 class="shadow-option5">Micro-Frontend</h1>
        <p class="align-right">오른쪽 정렬</p>
        <p class="align-left">왼쪽 정렬</p>
        <p class="align-center">가운데 정렬:ㄹㅇㄴㄴㄴ ㄴㄴㄴㄴㄴ ㄴㄴㄴㄴㄹㄴㅇㄻㄴㄻ흇ㄷㄹㄴ ㅍㄴsdfㄴㅇㅀㅀㄹㄴㄹㄴㄹㄴㅗㄴㅇㄹ뉻ㄱㅎㄴㄹㅇㅎㅇㄴㅇㄹ ㄹㄴㅇㄹㄴㄷㅅㅁㅎㄱㅎ뫃ㅇㄴㅍㄿㅍㅍ ㅎㄶㄴㅅㄱㅇㅎㄴㅍㅌㅍㄹㅇㅎㅁㅇㄶㄴㄷㅈㅅㅈㅎㄴㄹㅇㄹㄹㄴ ㄴㄴㄴㄴㄴㄴㄴㄴㄴ ㄴㄴㄴㄴㄴㄴㄴㄴㄴㄴㅁㄴㅇㄹ</p>
        <p class="align-justify">양쪽 정렬:ㄹㅇㄴㄴㄴ ㄴㄴㄴㄴㄴ ㄴㄴㄴㄴㄹㄴㅇㄻㄴㄻ흇ㄷㄹㄴ ㅍㄴsdfㄴㅇㅀㅀㄹㄴㄹㄴㄹㄴㅗㄴㅇㄹ뉻ㄱㅎㄴㄹㅇㅎㅇㄴㅇㄹ ㄹㄴㅇㄹㄴㄷㅅㅁㅎㄱㅎ뫃ㅇㄴㅍㄿㅍㅍ ㅎㄶㄴㅅㄱㅇㅎㄴㅍㅌㅍㄹㅇㅎㅁㅇㄶㄴㄷㅈㅅㅈㅎㄴㄹㅇㄹㄹㄴ ㄴㄴㄴㄴㄴㄴㄴㄴㄴ ㄴㄴㄴㄴㄴㄴㄴㄴㄴㄴㅁㄴㅇㄹ</p>
        <div class="box1"></div>
        <div class="box2"></div>
...
.shadow-option4 {
    ...
    color: #000;
    text-shadow: 0 0 4px #ccc, /* 수평거리 수직거리 흐림정도*/
        0 -5px 4px #ff3,
        2px -10px 6px #fd3,
        -2px -15px 11px #f80,
        2px -19px 18px #f20;
