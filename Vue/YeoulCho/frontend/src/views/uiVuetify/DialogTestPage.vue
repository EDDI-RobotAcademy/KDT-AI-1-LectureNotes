<template lang="">
    <div>
        ...
        <p class="teal lighten-1 text-center">Test</p> <!--text cneter 특정한 부분 center-->
        
        <v-btn class="teal lighten-3" rounded @click="btnClick">버튼</v-btn>
        <v-layout justify-center>
            <v-dialog v-model="isDialogOpened" fullscreen persistent max-width="400"> <!--fullscreen빼면 작은사이즈-->
...
export default {
    data(){
        return{
            globalAggroTitle: '지금즉시결제',
            aggroSupport: '오늘만 할인률 50%!!!',
            aggroFinish: '당장 결제하시겠습니까?',
            name: '7박 8일 풀 패키지코스',
