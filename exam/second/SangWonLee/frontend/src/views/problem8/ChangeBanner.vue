...
export default {
    data() {
        return {
            carouselModel: false,
            bannerPictures: [
                { img: require("@/assets/downloadImg/abcd.jpg") },
                { img: require("@/assets/downloadImg/good.jpg") },
                { img: require("@/assets/downloadImg/bird.jpg") },
                { img: require("@/assets/downloadImg/efg.jpg") },
            ],
            cycle: true,
            interval: 2500,
            height: 200,
