...
public class Manager {
    ...
    // 사용 방법
    // 1. List<데이터타입>을 작성합니다. -> 데이터타입 (지금은 커스텀 클래스타입으로 사용)
    // 2. 리스트 변수명을 적습니다.
    ...
    public void addRandomMember() {
        ...
        for (int i = 0; i < MAX_MEMBER_NUMBER; i++) {
            String tmpString = "";
            int emailLength = CustomRandom.generateNumber(MIN_EMAIL_LENGTH, MAX_EMAIL_LENGTH); // 최소길이4 최대길이8
