...
public class SwitchTest {
    public static void main(String[] args) {
        ...
        // 현재 콘솔 상황에서 사용자 입력을 받기 위해 아래코드가 사용된다 보면 되겠습니다.
        // 사용자 입력이란 구체적으로 키보드 입력을 의미합니다.
        // System.in이란 입력 시스템을 의미하므로
        ...
        while (isLoop) {
            ...
            //       case 0: 의 의미는 '입력한 숫자가 0이면' 이라는 뜻을 가집니다.
            //       case 1: 은 '입력된 숫자가 1이면' 이라는 뜻입니다.
        ...
        switch (inputNumber) {
            ...
            // isLoop가 참이면 계속 반복 - 와중에 키보드 입력을 받는다.
            }
        }
    }
}