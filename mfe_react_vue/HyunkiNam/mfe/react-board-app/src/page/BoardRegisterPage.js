...
import BoardRegisterFrom from '../components/BoardRegisterForm'
...
const BoardRegisterPage = () => {
    ...
    // Vue에서 onSubmit 같은 역할 (emit으로 Event 받아오는 것과 유사)
    // props인지 emit인지 구별이 잘 안되서 혼선을 유발하므로 주의가 필요
    return <BoardRegisterFrom onRegister={onRegister} />
}
