...
public class LambdaTest {
    ...
    회의 백날 해보야 결론이 안나오고 여기에 쓸모없이 소요해야 하는 시간과 비용이 매우 큽니다.
