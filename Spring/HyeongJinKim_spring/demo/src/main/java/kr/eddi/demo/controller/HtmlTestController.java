...
// Sl4fj는 log.info()에 정보를 출력하기 위한 목적으로 사용합니다.
// 아래와 같은 메시지가 나옵니다.
// 2023-04-10T11:39:35.154+09:00  INFO 5188 ---
// [nio-8080-exec-7] c.e.d.h.controller.HtmlTestController    : Is it Ok ?
// 나중에 프로젝트 할 때도 어디에서 문제 터졌는지 추적하기 위해 반드시 필요합니다.
// 지금 작업이 어디까지 진행되었는지 파악을 할 수 있기 때문에 중요합니다.

// RequestMapping은 Domian을 분리하기 위한 목적으로 사용합니다.
// 작업 예로 product/register, board/register 같은게 있다 가정해봅시다.
// register만 보면 이게 상품 등록일까? 게시문 등록일까? 뭘까? 알 수가 없습니다.
...
public class HtmlTestController {
    ...
    // HTTP 통신 방식의 GET, POST, PUT, DELETE가 존재합니다.
    ...
    public String printTime (Locale locale, Model model) {
        ...
        // html 코드 printTime.html호출 (resources/templates/printTime.html)
        return "printTime";
    }
}