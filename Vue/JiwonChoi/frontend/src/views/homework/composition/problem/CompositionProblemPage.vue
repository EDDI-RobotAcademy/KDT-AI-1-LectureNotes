...
export default {
  ...
  computed: {
    ...mapState(fastApiModule, [
      "receivedFastApiInteger",
      "receivedSpringFromFastApiInteger",
    ]),
    ...mapState(springModule, ["receivedSpringInteger"]),
    compositionInteger() {
      return (
        this.$store.state.fastApiModule.receivedFastApiInteger +
  ...
  methods: {
    ...
    ...mapActions(springModule, ["requestIntegerToSpring"]),
  },
  async created() {
