...
public class StackArrayTest {
    public static void main(String[] args) {
        ...
        // 그냥 아! new를 했기 떄문에 Heap에 있구나 정도면 OK
        ...
        // 3. 콜론 하나 찍습니다(:)
        // 3. 정보를 하나씩 꺼내 올 배열을 적어줍니다 (여기선 numberArray)
