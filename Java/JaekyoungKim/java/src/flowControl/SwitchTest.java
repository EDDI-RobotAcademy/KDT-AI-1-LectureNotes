...
public class SwitchTest {
    public static void main(String[] args) {
        ...
        //헌재 콘솔 상황에서 사용자 입력을 받기 위해 아래 코드가 사용된다 보면 되겠습니다.
        //사용자 입력이란 구체적으로 키보드 입력을 의미합니다.
        //System.in 이란 입력 시스템을 의미하므로
        //입력장치에 해당하는 키보드를 의미한다 봐도 무방하다.
        ...
        while(isLoop){
            ...
            //  만약 double 형을 원한다면 nextDouble()
            //  float 타입을 원하면 nextFloat() 형태로 사용하면 된다.
            int inputNumber= scan.nextInt();
            // switch 문을 작성하는 방법
            //  1. switch 적고 소괄호를 작성하고 중괄호를 작성한다.
            //  2. 소괄호 내부에 switch case에서 사용할 조건을 적습니다..
            //      현재 케이스에서 inputNumber는 숫자이므로
            //      ㅊㅁㄴㄷ 0:dml dmlalsms '입력된 숫자가 0이면' 이란 뜻을 가집니다.
            ...
            case 0:
                ...
                //숫자 0이 들어오는 겨우 isLoop 를 false로 바꿈
                isLoop= false;
                break;
            case 1:
